    ...
    <div class="container-fluid" data-aos="fade-up">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <h2>Kami berlokasi di Kota Kendari serta fokus untuk melatih pembelajaran pemrograman Web dan Mobile
                    secara online dan offline</h2>
                <div><a href="#about" class="btn-get-started scrollto">Mulai Belajar</a></div>
            </div>
